...
<body>
	...
	<hr>
	<br> 매장명 :
	<input type="text" value="${requestScope.store.storeName }" disabled
		class="form-control">
	<br>
	<c:if
	...
	<br /> 매장 주소 :
	<input type="text" value="${requestScope.store.storeAddress }" disabled
		class="form-control">
	<br> 매장 이메일 :
	<input type="text" value="${requestScope.store.storeEmail }" disabled
		class="form-control">
	<br> 매장 여는 시간 :
	<input type="text" value="${requestScope.store.storeOpenFormat }"
		disabled class="form-control">
	<br> 매장 닫는 시간 :
	<input type="text" value="${requestScope.store.storeCloseFormat }"
		disabled class="form-control">
	<br>
	<p />
	...
	<form action="${initParam.rootPath }/findProductListController.do"
		...
		<button type="submit" class="btn-custom">
			<i class="glyphicon glyphicon-list"></i>제품목록
		</button>
	</form>
