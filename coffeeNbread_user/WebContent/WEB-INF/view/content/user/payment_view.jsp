...
<table class="w3-table-all">
 ...
 <p> 
    ...
    총금액<input type="text"  value="${requestScope.totalPrice }"> </p> 
  ...
  즐겨찾는 카드번호 
	...
	<sec:csrfInput />
	        <input type="tel" size="20" name="cardNum" value="${requestScope.cardNum }"/>
          	<input type="submit" value="카드번호 등록">
    </form> 
    ...
    <c:forEach items="${requestScope.bookMarkCardNumList }"
				var="list">
               	${list.cardNum }
			</c:forEach>
	...
	<sec:csrfInput />
	        ...
	        <input type="hidden" name="productList" value="${list.product.productId }"/>
	        </c:forEach>
