...
public String toString() {
	return "ReservationDetails [reservationNo=" + reservationNo + ", reservationTime=" + reservationTime
			...
			+ ", productId=" + productId + ", productList=" + productList + ", product=" + product + ", storeId="
			+ storeId + ", store=" + store + ", generalUserList=" + generalUserList + "]";
}
...
@DateTimeFormat(pattern="yyyy-MM-dd HH:mm")
   ...
   public ReservationDetails(int reservationNo, Date reservationTime, int reservationCount, Date reservationConfirm,
		...
		Product product, String storeId, Store store, List<GeneralUser> generalUserList) {
	super();
