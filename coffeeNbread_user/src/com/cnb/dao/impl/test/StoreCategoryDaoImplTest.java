...
public class StoreCategoryDaoImplTest {
	...
	public void Test() {
		...
		System.out.println(dao.insertStoreCategory(new StoreCategory(10,"빵","s-5")));
		System.out.println(dao.updateStoreCategory(new StoreCategory(10,"대분류1","s-5")));
		System.out.println(dao.deleteStoreCategoryById(4));
