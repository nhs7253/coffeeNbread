...
public class RecipeBoardContentsDaoImplTest {
	...
	public static void main(String[] args) throws IOException {
		RecipeBoardContentsDaoImplTest nbcd = (RecipeBoardContentsDaoImplTest)new ClassPathXmlApplicationContext("com/cnb/config/spring/model-context.xml").getBean("noticeBoardContentsDaoImplTest");
