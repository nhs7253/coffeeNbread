...
public class PointOfSalesController {
	...
	@RequestMapping("findProductListToPOSController")
	public ModelAndView findProductListToPOSController(@ModelAttribute("pointOfSalesView") @Valid PointOfSalesViewForm pointOfSalesViewForm, BindingResult errors){
		...
		List<Product> list = pointOfSalesService.findProductListToPOSService(pointOfSalesViewForm.getStoreId(), pointOfSalesViewForm.getSelect(), pointOfSalesViewForm.getKeyword());
