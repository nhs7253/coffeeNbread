...
public class RecipeBoardContentsController {
	...
	@Autowired
	private RecipeBoardContentsService service;
	
	
	
	@RequestMapping("/common/findRecipeBoardContentsBySelectToKeyword")
	public ModelAndView findRecipeBoardContentsBySelectToKeyword(@ModelAttribute("allUserView") @Valid RecipeBoardContentsViewForm recipeBoardContentsViewForm, BindingResult errors){
		...
		Map<String,Object> map=service.findRecipeBoardContentsByMethod(recipeBoardContentsViewForm.getPage(), recipeBoardContentsViewForm.getSelect(),recipeBoardContentsViewForm.getKeyword());
		System.out.println("map:"+map);
		modelAndView.setViewName("common/recipeBoard_find.tiles"); //성공 시 이동할 경로
	...
	/*
	@RequestMapping("/common/findRecipeBoardContentsByMethod")
	public String addRecipeBoardContents(@ModelAttribute("recipeBoardContents") @Valid RecipeBoardContents recipeBoardContents, BindingResult errors){
